...
=item B<history_max> is an integer variable which defines the maximum number of history entries for a given prompt.  This variable should not be set from the interactive command line.  (default: 50)
